                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="social">
                            ...
                            <a class="social-link facebook" style="width: 20px;height: 20px;margin-top: -2px;vertical-align: top;background-size: auto 10px;" href="https://www.facebook.com/bromptonjunctionbarcelona/info/?entry_point=page_nav_about_item&amp;tab=overview" target="_blank"></a>
                            <a class="social-link instagram" style="width: 20px;height: 20px;margin-top: -2px;vertical-align: top;background-size: auto 10px;" href="https://www.instagram.com/bromptonjunctionbcn/" target="_blank"></a>
                        </div>
                        </span>
                    </li>
                </ul>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="vc_row wpb_row vc_row-fluid mpc-row"><div class="wpb_column vc_column_container vc_col-sm-12 mpc-column" data-column-id="mpc_column-1859e8c2d5bb524"><div class="vc_column-inner "><div class="wpb_wrapper">
            ...
            <div class="content-wrapper">
                <div class="signup-and-social">
                    ...
                    <div class="social">
                        ...
                        <a class="social-link facebook" href="index.html" target="_blank">
